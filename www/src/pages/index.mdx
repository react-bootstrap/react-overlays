...
React Overlays toolkit for creating functional overlays, tooltips, modals, and dropdowns.
It is not a ui framework, but meant to be incorporated _into_ frameworks. To make those integrations
...
document body. These can technically be overridden but it's very unlikely that should
required.
